...
public class InsertUpdateIntercepter implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (parameter instanceof MapperMethod.ParamMap) {
            ...
            paramMap.keySet().forEach(key -> {
                ((List)paramMap.get(key)).forEach(list->{
                    try {
                        generateSingle(sqlCommandType,list);
                    } catch (Throwable e) {
            ...
            generateSingle(sqlCommandType,parameter);
        }
        // 获取私有成员变量
    ...
    private void generateSingle(SqlCommandType sqlCommandType,Object parameter) throws Throwable {
